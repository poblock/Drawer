...
class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.AlbumViewHolder> {
  ...
  public AlbumViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.demo_item_album, parent, false);
    ...
    holder.main.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
          options = ActivityOptions.makeSceneTransitionAnimation((Activity) mContext, holder.thumbnail, "picturetransition");
          Intent intent = AlbumDetailActivity.makeIntent(mContext, album);
